            ...
            <tr>
                <c:forEach begin="1" end="${noOfPages}" var="i">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <td>
                                <a href="${pageContext.request.contextPath}/controller?page=${i}&command=findParcels&&status=Delivered&sortColumnNumber=${sortColumnNumber}&address=all_report.jsp">${i}</a>
                            </td>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
